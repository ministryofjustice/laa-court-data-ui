...
RSpec.describe TableSorters::HearingsSorter do
  ...
  describe ".for" do
    ...
    context "when column is provider" do
      ...
      it {
        expect(subject).to be_instance_of(TableSorters::HearingsProviderSorter)
      }
    end
    ...
    context "when column is type" do
      ...
      it {
        expect(subject).to be_instance_of(TableSorters::HearingsTypeSorter)
      }
    end
    ...
    context "when column is date" do
      ...
      it {
        expect(subject).to be_instance_of(TableSorters::HearingsDateSorter)
      }
    end
