...
RSpec.describe Cda::DefenceCounselDecorator, type: :decorator do
  ...
  describe "#name_status_and_defendants" do
    ...
    let(:mapped_defendants) do
      [build(:defendant_summary, first_name: "John", middle_name: nil, last_name: "Doe")]
    end
    ...
    context "when multiple defendants" do
      let(:mapped_defendants) do
        [build(:defendant_summary, first_name: "John", middle_name: nil, last_name: "Doe"),
         build(:defendant_summary, first_name: "Jane", middle_name: nil, last_name: "Doe")]
      end

      it "displays the provider defendant relationship" do
        expect(subject).to eql("Bob Smith (QC) for John Doe<br>Bob Smith (QC) for Jane Doe")
      end
    end
    ...
    context "when defendants name is partially missing" do
      let(:mapped_defendants) do
        [build(:defendant_summary, first_name: "John", middle_name: "Jim", last_name: nil)]
      end
    ...
    context "when defendant_id to defendant_details match fails" do
      ...
      let(:defendant) { build(:defendant_summary, first_name: "John", middle_name: "Jim", last_name: nil) }
