...
RSpec.describe User, type: :model do
  ...
  describe "#name" do
    ...
    it 'returns "firstname lastname"' do
      expect(subject).to eql "John Smith"
    end
  end
    ...
    context "when no login set" do
      ...
      context "with user with no username" do
        ...
        it "uses the users email attribute" do
          expect(subject).to eql "john.smith@example.com"
        end
      end
    end
  end
  ...
  describe "roles" do
    describe ".valid_roles" do
      ...
      it "returns all valid roles for class" do
        expect(subject).to eq %w[caseworker admin data_analyst]
      end
    end
    ...
    describe "#roles" do
      ...
      it "returns roles on user object" do
        expect(subject).to eq %w[caseworker admin]
      end
    end
  end
