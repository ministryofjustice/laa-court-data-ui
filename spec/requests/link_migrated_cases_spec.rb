...
RSpec.describe "link_migrated_cases", type: :request do
  ...
  context "when the pending tab is requested", :stub_link_migrated_cases, :stub_oauth_token do
  ...
  context "when the auto_linked tab is requested", :stub_link_migrated_cases, :stub_oauth_token do
