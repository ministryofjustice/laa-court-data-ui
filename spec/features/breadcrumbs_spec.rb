...
RSpec.feature "Breadcrumb", :stub_unlinked, type: :feature do
  ...
  context "when signed in" do
    ...
    context "when on hearing details page", :stub_defendants_case_search, :stub_hearing_summary, :stub_internal_v2_hearing_results, :stub_v2_hearing_events do
      scenario "expected breadcrumbs are displayed" do
        when_i_choose_search_filter "A case by URN"
        when_i_search_for case_urn
    ...
    scenario "user navigates search, prosecution case, defendant and hearings pages",
             :stub_defendants_case_search, :stub_hearing_summary, :stub_internal_v2_hearing_results, :stub_v2_hearing_events do
      when_i_choose_search_filter "A case by URN"
      when_i_search_for case_urn
