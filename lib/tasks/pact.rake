namespace :pact do
  namespace :consumer do
    ...
    desc "Publish pact files for all consumer contracts to the pact broker"
    task publish: :environment do
      raise "PACT_BROKER_URL environment variable is required to publish pacts" if ENV["PACT_BROKER_URL"].blank?
      ...
      abort("Pact publish failed") unless system(*command)
    end
  end
end
