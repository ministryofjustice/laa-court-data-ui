...
module LaaCourtDataUi
  class Application < Rails::Application
    ...
    # Direct connection to CDA V2
    config.x.court_data_adaptor_api_v2_url = ENV.fetch("COURT_DATA_ADAPTOR_API_V2_URL", nil)
    config.x.court_data_adaptor_api_uid = ENV.fetch("COURT_DATA_ADAPTOR_API_UID", nil)
    config.x.court_data_adaptor_api_secret = ENV.fetch("COURT_DATA_ADAPTOR_API_SECRET", nil)
