module Cda
  class CourtApplicationLaaReference < BaseModel
    ...
    def self.create(link_attempt)
      ...
      http_response = post('', nil, { court_application_laa_reference: }.to_json)
      http_response.code.to_i.in?(200..299)
    end
    ...
    def self.update(unlink_attempt)
      ...
      http_response = patch(unlink_attempt.defendant_id, nil, { laa_reference: }.to_json)
      http_response.code.to_i.in?(200..299)
    end
  end
end
